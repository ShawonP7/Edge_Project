...
class _EditPrayerTimesScreenState extends State<EditPrayerTimesScreen> {
  ...
  // ✅ Load Current Prayer Times into Controllers
  void _loadPrayerTimes() {
    var times = widget.mosque["prayer_times"];
    _fajrController.text = times["Fajr"];
    _dhuhrController.text = times["Dhuhr"];
    _asrController.text = times["Asr"];
    _maghribController.text = times["Maghrib"];
    _ishaController.text = times["Isha"];
  }
  ...
  Future<void> _updatePrayerTimes() async {
    ...
    Navigator.pop(context); // Go back to mosque details
  }
